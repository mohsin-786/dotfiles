...
myEditor :: String
myEditor = "geany"  -- Sets emacs as editor
...
myKeys c =
  ...
  , ("M-<Space>", addName "Toggle noborders/full" $ sendMessage (MT.Toggle NOBORDERS))
  , ("M-a", addName "Toggle noborders/full" $ sendMessage (MT.Toggle NBFULL) >> sendMessage ToggleStruts)]
  ...
  [ ("<XF86AudioPlay>", addName "audacious play/pause"     $ spawn "audacious -t")
